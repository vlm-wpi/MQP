...
OUTPUT=results_Fuller_backpack
...
# Set Up
# ------------------------------------
INPUT_ARGS="--width=100 --height=100 --c=0 --a=0 --ab=0 --heuristic=euclidean --layout=FullerLower --conflict1=ChooseRandomMove-3 --conflict2=ChooseDifferentExit-6 --conflict3=takeOthersIntoAccount-9 --conflict4=NullConflictStrategy-12 --output=results_Fuller_backpack"
