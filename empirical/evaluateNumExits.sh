...
# Set Up
# ------------------------------------
INPUT_ARGS="--width=100 --height=100 --c=25 --a=25 --abp=25 --ab=10 --o=100 --heuristic=euclidean --layout=Randomized --conflict1=ChooseRandomMove-3 --conflict2=ChooseDifferentExit-6 --conflict3=takeOthersIntoAccount-9 --conflict4=NullConflictStrategy-12 --output=output7"
